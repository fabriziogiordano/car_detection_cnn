...
# Step 1: Define the dataset (same as before)
...
torch.save(model.state_dict(), 'car_detection_model_custom.pth')
...
# Example usage
model.load_state_dict(torch.load('car_detection_model_custom.pth'))
